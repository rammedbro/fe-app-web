<template>
  <div class="flex h-[50vh] flex-col items-center justify-center text-center">
    <h1 class="text-4xl font-bold">{{ t('pages._error.title', { status: props.status }) }}</h1>
...
const message = computed(() => (is404 ? t('pages._error.messages.404') : t('pages._error.messages.500')));
</script>
