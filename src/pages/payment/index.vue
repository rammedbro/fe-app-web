    ...
    <div class="lg:w-2/3">
      ...
      <section class="bg-white drop-shadow-md rounded-lg p-6">
        <div class="relative mb-6">
          ...
          <div class="text-sm text-content-300">We are getting to the end. Just few clicks and your rental is ready!</div>
    ...
    <aside class="lg:w-1/3 bg-white drop-shadow-md rounded-lg p-6">
      ...
      <div class="flex flex-wrap items-center gap-4">
        <img
          ...
          class="md:max-w-72 rounded-lg"
        />
        <div>
          <div class="text-4xl font-bold mb-2">Nissan GT - R</div>
      ...
      <div class="flex justify-between mb-2">
        ...
        <div class="font-semibold">$80.00</div>
      </div>

      <div class="flex justify-between mb-8">
        <div class="text-content-300">Tax</div>
      ...
      <div class="flex items-center justify-between gap-4">
        ...
        <div class="text-4xl font-bold">$80.00</div>
      </div>
    </aside>
  </div>
</template>
