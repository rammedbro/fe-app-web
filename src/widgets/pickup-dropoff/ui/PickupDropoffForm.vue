<template>
  <div class="bg-white rounded-lg p-4 xl:px-12 xl:py-6">
    <slot name="title" />
    ...
    >
      <div>
        ...
        <Select size="small" fluid placeholder="Select your city" input-class="pl-0" class="border-0 shadow-none" />
      </div>

      <Divider v-if="layout === 'horizontal'" layout="vertical" />
